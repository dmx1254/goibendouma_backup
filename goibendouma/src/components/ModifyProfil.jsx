...
const ModifyProfil = () => {
  ...
  return (
    <div className="modifyprofil">
      <button
        className="modifyprofil-absolute"
        onClick={handleDeleteAccount}
        data-tip={
          language === "anglais" ? "delete my account" : "Supprimer mon compte"
        }
      >
        <span className="delete-acount-btn">
          <TiUserDelete />
        </span>
      </button>
      <ReactTooltip 
      ...
      />
      {/* <span className="delete-my-account">
        {language === "anglais" ? "delete my account" : "Supprimer mon compte"}
      </span> */}
      {modifProfil || (
